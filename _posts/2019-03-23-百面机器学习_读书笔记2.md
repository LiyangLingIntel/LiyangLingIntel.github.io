...
<img src="https://ws2.sinaimg.cn/large/006tKfTcly1g1iu3pl3cfj30y40os0xe.jpg" width="330" /><img src="https://ws4.sinaimg.cn/large/006tKfTcly1g1iu4qt2qtj30y40nyjxo.jpg" width="345" />
...
4. 取特征值前d大的特征向量$w_1,w_2, ... ,w_d$, 将n维样本映射到d维

   $x'_i = \begin{bmatrix}w_1^Tx_i\\ w_2^Tx_i\\ \vdots \\ w_d^Tx_i\end{bmatrix}$
...
<img src="https://ws2.sinaimg.cn/large/006tKfTcly1g1j46643dyj30yo0ogaf8.jpg" width="330"/><img src="https://ws1.sinaimg.cn/large/006tKfTcly1g1j47dy65qj30yo0ocgss.jpg" width="330" />
...
<img src="https://ws2.sinaimg.cn/large/006tKfTcly1g1j4eahgzsj30n00o2doi.jpg" width="280" />
...
$$D(C_1, C_2)=||\tilde\mu_1-\tilde\mu_2||^2_2$$，
...
<img src="https://ws4.sinaimg.cn/large/006tKfTcgy1g1jx051r1vj30sw0ogal6.jpg" width="330" /><img src="https://ws1.sinaimg.cn/large/006tKfTcgy1g1jx0t8d1rj30sw0o8gvf.jpg" width="330" />
...
因为在简化的二分类问题中，$w^TS_ww$和$w^TS_Bw$是两个数，所以可以令$\lambda=J(w)=\frac{w^TS_Bw}{w^TS_ww}$。于是上面的解可以写为

$$S_Bw=\lambda S_ww，即S_w^{-1}S_Bw=\lambda w$$。
...
4. 取前d大的特征值对应的特征向量$w_1,w_2, ... ,w_d$, 将n维样本映射到d维
