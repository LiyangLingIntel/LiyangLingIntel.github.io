...
layout:     post
title:      "拉格朗日乘数法和KKT条件"
subtitle:   拉格朗日乘法和KKT条件[转载]
date:       2019-04-08
author:     Lyon Ling
header-img: img/post-bg-kkt.png
catalog: true
mathjax: true
tags:
    - Maths
...
$$(\pm\sqrt{2},1,−1);(\pm\sqrt2,−1,1);(0,\pm\sqrt3,0)$$
...
这就需要引出**KKT条件**（Karush-Kuhn-Tucker Conditions），它是在满足一些有规则的条件下，一个**非线性规划问题能有最优化解法**的一个**必要和充分条件**

考虑以下非线性最优化问题，含有 $m$ 个不等式约束，$l$ 个等式约束
$$min_xf(x)\qquad s.t.\quad g_i(x)⩽0,h_j(x)=0$$
...
本文转载自[【直观详解】拉格朗日乘法和KKT条件](<https://charlesliuyx.github.io/2017/09/20/%E6%8B%89%E6%A0%BC%E6%9C%97%E6%97%A5%E4%B9%98%E6%B3%95%E5%92%8CKKT%E6%9D%A1%E4%BB%B6/>)